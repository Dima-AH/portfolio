                        ...
                        <div className="md:w-2/3 p-6 md:p-8">
                          ...
                          <div className="flex flex-wrap gap-3">
                            <a 
                              ...
                              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-cyan-500 to-purple-500 text-white text-sm font-medium rounded-lg hover:from-cyan-600 hover:to-purple-600 transition-all duration-300 shadow-lg shadow-purple-500/20"
                            >
                        ...
                        <div className="md:w-1/3 relative">
                          <div className="h-48 md:h-full bg-gradient-to-br from-cyan-500/5 to-purple-500/5 flex items-center justify-center border-t md:border-t-0 md:border-r border-gray-600/30">
                            <div className="text-cyan-400/50">
                              <Image src={"/images/sociehub.png"} alt='sociehub-image' width={600} height={600}/>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 p-8">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-400 mb-6 text-sm max-w-xl mx-auto">
                      برای تبدیل ایده‌هایتان به محصول دیجیتالی با کیفیت، آماده همکاری هستم. 
                      بیایید در مورد جزئیات پروژه صحبت کنیم.
                    </p>
                    <Link 
                      href="/contact" 
